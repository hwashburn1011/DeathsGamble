    ...
    <div className="scene placeholder-scene">
      <GlassPanel padding="lg" className="placeholder-card">
        ...
        <p className="placeholder-text">
          ...
          The wheels and dungeon rendering are being ported to PixiJS in the next iteration.
        </p>
        <p className="placeholder-text">
          Want to play right now? Jump back to the v0.5 build below.
        </p>
        <div className="placeholder-actions">
          <a className="placeholder-link" href="legacy/v0.5.html">
            <GlassButton variant="gold" size="lg">Open v0.5</GlassButton>
          </a>
